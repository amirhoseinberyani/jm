...
public class MainFrame extends JFrame implements TestStateListener, Remoteable, DropTargetListener, Clearable, ActionListener {
    ...
    private static final String DEFAULT_APP_NAME = "کارا آزمون عملکرد"; // $NON-NLS-1$
    ...
    private void init() { // WARNING: called from ctor so must not be overridden (i.e. must be private or final)
        ...
        treePanel.applyComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
        treeAndMain.setRightComponent(treePanel);
        ...
        topAndDown.setResizeWeight(.2);
        topAndDown.setContinuousLayout(true);
        topAndDown.setBorder(null); // see bug jdk 4131528
        topAndDown.applyComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
        ...
        treeAndMain.setLeftComponent(topAndDown);
        treeAndMain.setResizeWeight(.8);
